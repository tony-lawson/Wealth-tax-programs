...
def taketax(a, year, wtax, wthreshold, mtax, mthreshold, ntax, nthreshold, redistribute, taxfreeallowance): # apply wealth tax to population, threshold is set in this function because it varies as the program runs
    ...
    if taxfreeallowance == True:
        print("mthreshold mtax, wtax", mthreshold, mtax, wtax)
...
midwealthtaxrate = 0.03 # wealth tax rate for middle band
midwealthtaxreach = 0.01 # proportion of population liable to middle band
narrowwealthtaxrate = 0.05 # wealth tax rate: narrow band
narrowwealthtaxreach = 0.00001 # proportion of population liable to tax: narrow band

# make sure top rate of tax is not less than middle rate and middle rate is not less than lower rate 
if widewealthtaxrate > midwealthtaxrate or midwealthtaxrate > narrowwealthtaxrate:
    print("Invalid wealth tax rates")
    sys.exit()
